...
required_pages=(
  ...
  "docs/reference/consumable-output.md"
  ...
  "scripts/extract-workflow-doc-examples.sh"
  "scripts/roadmap.sh"
...
if [ -f ".github/workflows/docs.yml" ]; then
  ...
  require_text ".github/workflows/docs.yml" "bash scripts/extract-workflow-doc-examples.sh"
  ...
  require_text ".github/workflows/docs.yml" "bash scripts/check-output-contract.sh"
  require_text ".github/workflows/docs.yml" "bash scripts/test-output-contract.sh"
...
if [ -f ".github/workflows/g0-contract.yml" ]; then
  ...
  require_text ".github/workflows/g0-contract.yml" "bash scripts/extract-workflow-doc-examples.sh"
  ...
  require_text ".github/workflows/g0-contract.yml" "bash scripts/check-output-contract.sh"
  require_text ".github/workflows/g0-contract.yml" "bash scripts/test-output-contract.sh"
