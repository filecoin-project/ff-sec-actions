...
| `examples/consumer-profile-detection.yml` | `ecosystem-baseline` | `ecosystem-baseline` | Advance the detector commit only after fixtures, output contracts, and consumer evidence pass review. |
